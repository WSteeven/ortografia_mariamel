...
//    var juego3Desbloqueado by remember { mutableStateOf(false) }
    var juego3U1Desbloqueado by remember { mutableStateOf(false) }
    ...
    LaunchedEffect(localNombre) {
        firebase.verificarJuegoCompletado(1, 3) {juego3U1Desbloqueado = it }
        firebase.verificarJuegoCompletado(2, 1) { juego1Desbloqueado = it }
        firebase.verificarJuegoCompletado(2, 2) { juego2Desbloqueado = it }
//        firebase.verificarJuegoCompletado(2, 3) { juego3Desbloqueado = it }
    }
...
//                            Log.d("ACTIVIDAD2-U1", "Click en el boton bloqueado $it")
                ...
                NivelJuego(
                    ...
                    onClickBloqueado = { snackbarMessage = "Aún no has completado todos los juegos de la UNIDAD 1. Por favor completalos para desbloquear este juego"},
                    modifier = Modifier
                        .fillMaxWidth()
