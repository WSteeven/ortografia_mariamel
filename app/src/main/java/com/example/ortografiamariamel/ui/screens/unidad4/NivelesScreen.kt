...
fun Niveles4(
    ...
    var juego3U3Desbloqueado by remember { mutableStateOf(false) }
    ...
    LaunchedEffect(localNombre) {
        firebase.verificarJuegoCompletado(3, 3) {juego3U3Desbloqueado = it }
        firebase.verificarJuegoCompletado(4, 1) { juego1Desbloqueado = it }
        firebase.verificarJuegoCompletado(4, 2) { juego2Desbloqueado = it }
        ...
        Column(
            ...
            Column(
                ...
                NivelJuego(
                    ...
                    onClick = {
                        viewModel.setPantallaJuegoU4(AppScreen.Actividad3U4)
                ...
                NivelJuego(
                    ...
                    descripcion = stringResource(id = R.string.nivel_intermedio), onClick = {
                        viewModel.setPantallaJuegoU4(AppScreen.Actividad2U4)
                        soundManager.playSound(R.raw.correct_card_sound)
                        onClick()
                    },
                ...
                NivelJuego(
                    isUnlocked = juego3U3Desbloqueado, descripcion = stringResource(id = R.string.nivel_basico), onClick = {
                        viewModel.setPantallaJuegoU4(AppScreen.Actividad1U4)
                        soundManager.playSound(R.raw.correct_card_sound)
                        onClick()
                    },
                    onClickBloqueado = { snackbarMessage = "Aún no has completado todos los juegos de la UNIDAD 3. Por favor completalos para desbloquear este juego"},
                    modifier = Modifier
                        .fillMaxWidth()
...
@Composable
fun Niveles4ScreenPreview() {
    OrtografiaMariamelTheme {
        Niveles4(viewModel = viewModel(factory = AppViewModelProvider.Factory))
    }
}
